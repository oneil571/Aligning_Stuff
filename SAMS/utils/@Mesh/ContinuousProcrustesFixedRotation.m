function [rslt] = ContinuousProcrustesFixedRotation(GM,GN,options)
...
if nargin<3
    ...
    options.MaxDistTol = 11;    %This will be replaced with weighted adjacency in future
...
scatter3(GM.V(1,TPS_FEATURESM_INDS),GM.V(2,TPS_FEATURESM_INDS),...
    GM.V(3,TPS_FEATURESM_INDS),100,'filled');
figure; GN.draw; hold on; 
scatter3(GN.V(1,TPS_FEATURESN_INDS),GN.V(2,TPS_FEATURESN_INDS),...
    GN.V(3,TPS_FEATURESN_INDS),100,'filled');
